...
public class PanelUsuario extends JPanel {
    ...
    public PanelUsuario(MantenimientoUsuario controlOriginal, int funcion) throws ClassNotFoundException, SQLException {
        ...
        stmt = (CallableStatement) con.prepareCall("{CALL insertar_usuario(?, ?, ?, ?, ?, ?, ?)}");
        ...
        botonGuardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (eleccion == 0) {
                        // stmt = con.prepareCall("{Call insertar_usuario(?,?,?,?,?,?,?)}");
                        ...
                        stmt.setString(6, txtUsuario.getText());
                        stmt.setString(7, txtClave.getText());
                        stmt.executeUpdate();
                    }
