...
public class MantenimientoCatalogoClasificacion extends JPanel {
    ...
    public MantenimientoCatalogoClasificacion() {
        ...
        // Botones
        botonInsertar = PanelCatalogoClasificacion.crearBoton("Insertar", 40, 360, 100, 40, "Insertar nueva clasificación", "Iconos/insertar-cuadrado.png");
        botonInsertar.setBackground(new Color(46, 204, 113)); botonInsertar.setForeground(Color.WHITE); this.add(botonInsertar);

        botonActualizar = PanelCatalogoClasificacion.crearBoton("Actualizar", 200, 360, 100, 40, "Actualizar clasificación existente", "Iconos/boton-editar.png");
        botonActualizar.setBackground(new Color(255, 179, 71)); botonActualizar.setForeground(Color.WHITE); this.add(botonActualizar);

        botonEliminar = PanelCatalogoClasificacion.crearBoton("Eliminar", 360, 360, 100, 40, "Eliminar clasificación existente", "Iconos/eliminar.png");
        botonEliminar.setBackground(new Color(240, 128, 128)); botonEliminar.setForeground(Color.WHITE); this.add(botonEliminar);

        botonConsultar = PanelCatalogoClasificacion.crearBoton("Consultar", 520, 360, 100, 40, "Consultar clasificación existente", "Iconos/buscar.png");
        botonConsultar.setBackground(new Color(135, 206, 250)); botonConsultar.setForeground(Color.WHITE); this.add(botonConsultar);

       

        JTextField campoActualizar = PanelCatalogoClasificacion.crearCampoTexto(200, 410, 100, 30, "Ingrese ID a actualizar"); this.add(campoActualizar);
        JTextField campoEliminar = PanelCatalogoClasificacion.crearCampoTexto(360, 410, 100, 30, "Ingrese ID a eliminar"); this.add(campoEliminar);
        JTextField campoConsultar = PanelCatalogoClasificacion.crearCampoTexto(520, 410, 100, 30, "Ingrese ID a consultar"); this.add(campoConsultar);
        ...
        botonInsertar.addActionListener(e -> {
            try {
                ...
                panel = new PanelCatalogoClasificacion(MantenimientoCatalogoClasificacion.this,0);
        ...
        botonActualizar.addActionListener(e -> {
            ...
            try {
               ...
               // this.remove(campoActualizar); this.remove(campoEliminar); this.remove(campoConsultar);
                ...
                panel = new PanelCatalogoClasificacion(MantenimientoCatalogoClasificacion.this,1);
                panel.setLayout(null); panel.setBounds(10, 70, 700, 500);
                this.add(panel); this.setComponentZOrder(panel, 0); this.revalidate(); this.repaint();
            } catch (Exception ex) { ex.printStackTrace(); }
